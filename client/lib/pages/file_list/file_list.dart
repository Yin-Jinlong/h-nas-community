...
import 'package:h_nas/pages/file_list/info_dialog.dart';
import 'package:h_nas/pages/file_list/new_folder_dialog.dart';
import 'package:h_nas/pages/file_list/rename_dialog.dart';
import 'package:h_nas/pages/file_list/sort_dialog.dart';
...
part 'file_list.context_menu.dart';
part 'file_list.floating_action_button.dart';
part 'file_list.image_viewer.dart';

class FileListPage extends StatefulWidget {
  const FileListPage({super.key});

  @override
  State createState() => _FileListPageState();
}
...
class _FileListPageState extends State<FileListPage>
  ...
  void _showFileInfo(FileInfo file) {
    showDialog(
      context: context,
      builder: (context) {
  ...
  void _newFolderMenu(BuildContext context) {
    showDialog(
      context: context,
      builder: (context) {
  ...
  void _onUploadMenu(String dir) async {
    if (UniversalPlatform.isWeb) {
